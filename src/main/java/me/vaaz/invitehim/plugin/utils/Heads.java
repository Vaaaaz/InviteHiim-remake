...
public class Heads {
    ...
    static {
        ...
        Heads.MAGENTA = new ItemBuilderCustom(Material.PLAYER_HEAD, 1, 3).setSkullOwner("diablo3pk").toItemStack();
        Heads.BRANCO = new ItemBuilderCustom(Material.PLAYER_HEAD, 1, 3).setSkullOwner("cy1337").toItemStack();
        Heads.LARANJA = new ItemBuilderCustom(Material.PLAYER_HEAD, 1, 3).setSkullOwner("wulfric17").toItemStack();
